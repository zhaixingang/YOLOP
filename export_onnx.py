...
if __name__ == "__main__":
    ...
    torch.onnx.export(model, inputs, output_onnx, verbose=False, opset_version=11, input_names=['images'], output_names=['det_out0', 'det_out1', 'det_out2', 'drive_area_seg', 'lane_line_seg'])
